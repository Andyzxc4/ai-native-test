...
const QRGeneratePage: React.FC = () => {
  ...
  const downloadQR = () => {
    ...
    if (canvas) {
      ...
      link.download = `merchant-qr-${user?.id}-${Date.now()}.png`
          ...
          <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6 text-center">
                ...
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                    Display this QR code for customers to scan and pay
                  </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Customers can scan it using their payment app</li>
                <li>• You'll receive payments instantly</li>
              </ul>
            </div>
          </div>
        </div>
